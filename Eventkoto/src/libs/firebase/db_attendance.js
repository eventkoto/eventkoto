...
const db_address = "Attendance";
export const attendance_db_address = db_address;

function docAddress(id){
  return doc(db, db_address, id)
}

export const FireDBAttendance = {
  data : {
    attendanceTemplate : (user_id, user_snap, user_name, event_id, event_snap, event_name) => {
      return {
