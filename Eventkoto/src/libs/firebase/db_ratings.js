...
const db_address = "Ratings";
export const ratings_db_address = db_address;

function docAddress(id){
  return doc(db, db_address, id)
}

export const FireDBRatings = {
  data : {
    ratingsTemplate : (user_id, user_snap, user_name, event_id, event_snap, event_name, ratings) => {
      return {
        user_id, user_snap, user_name, event_id, event_snap, event_name, ratings
      }
    },
  },
  create: async (data) => {
